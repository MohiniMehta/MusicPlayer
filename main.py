...
class SignInSignUp:
    def __init__(self):
        ...
        self.main_window = Tk()
        self.main_window.title("Login/Sign-Up")
        ...
        self.signin_button = Button(self.main_window, text="Sign In", command=self.sign_in)
        self.signin_button.pack(pady=5)

        self.signup_button = Button(self.main_window, text="Sign Up", command=self.sign_up)
    ...
    def sign_up(self):
        ...
        if not is_password_valid(password):
            messagebox.showerror("Error", "Password is invalid. It must contain at least 8 characters, including letters, numbers, and special symbols.")
            return
        try:
